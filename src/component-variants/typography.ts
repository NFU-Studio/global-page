...
export const typographyVariants = cva("", {
  variants: {
    variant: {
      body: "text-sm font-medium leading-relaxed text-foreground/65 in-data-[inverted=true]:text-background/65",
      ...
      large: "font-display text-lg lg:text-xl text-balance font-medium",
